                  ...
                  <div class="x_content">
                    ...
                    <form name="EliminarUsuario" method="post" action="<?php echo getUrl("Usuario", "Usuario", "postEliminarUsuario"); ?>" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                       ...
                       <?php
                        ...
                        ?>
                            <input type="hidden" name="usu_id" required value="<?php echo $usuario['usu_id']; ?>" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="usu_nickname" required="required" class="form-control col-md-7 col-xs-12" readonly value="<?php echo $usuario['usu_nickname'];?>">
                                </div>
                            </div>
                            <div class="form-group">
